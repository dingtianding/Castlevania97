...
export const BULLET_SOUL_POOL: readonly BulletSoulDef[] = [
  ...
  },
  {
    ...
    mpCost: 22,
    pattern: 'bolt',
    blurb: 'Canon effect: a boomerang throw. Name, source, and MP cost all match canon; the out-and-back curve is not modeled, so it is a straight bolt.',
  },
  {
    id: 'bat-soul',
    name: 'Bat Soul',
    ...
    mpCost: 5,
    pattern: 'nova',
    blurb: 'Canon effect: a short-range sonar wave. Name, source, and MP cost all match canon; modeled here as a small burst.',
  },
  {
    id: 'evil-butcher-soul',
    name: 'Evil Butcher Soul',
    enemyId: 'evilButcher',
    dropChance: 0.24,
    mpCost: 5,
    pattern: 'bolt',
    blurb: 'Canon effect: a dagger throw. Name, source, and MP cost all match canon.',
  },
  {
    id: 'skull-millone-soul',
    name: 'Skull Millone Soul',
    enemyId: 'skullMillone',
    dropChance: 0.22,
    mpCost: 25,
    pattern: 'bolt',
