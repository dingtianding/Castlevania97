...
export const CAMPAIGN_CHAPTERS: readonly CampaignChapterDef[] = [
  ...
  },
  {
    ...
    intro:
      'The gate that should have stayed shut stands open. Against every warning, young Julius steps through — into the castle that will not truly exist for two more years, and the thing gathering at its heart.',
    outro:
    ...
    nodeIds: ['gate-ascent', 'gate-spire', 'gate-hall', 'gate-vault', 'gate-keep'],
  },
]
...
export const CAMPAIGN_NODES: readonly CampaignNodeDef[] = [
  ...
  {
    id: 'gate-ascent',
    chapterId: '1999-castle',
    year: 1997,
    title: 'Inner Stair',
    blurb: 'The gate opens onto a stair that climbs into geometry that should not hold.',
    story:
      'Past the threshold the castle assembles itself around Julius — cold marble, endless stairs, and defenders who no longer pretend to be human.',
    stage: 'throne_room',
    enemy: skeleton,
    extraEnemies: [{ def: armoredSkeleton, count: 1 }],
    difficulty: 'hard',
    nextIds: ['gate-spire', 'gate-hall'],
  ...
  },
  {
    ...
    year: 1997,
    title: 'Broken Spire',
    blurb: 'A shattered spire off the stair, open to a sky that is the wrong colour.',
    story:
      'Julius climbs a spire the castle has already begun to forget. Its guardians fight with the desperation of things that know they are only a rehearsal.',
    stage: 'clock_tower',
    enemy: skeleton,
    extraEnemies: [{ def: boneThrower, count: 1 }, { def: ghoul, count: 1 }],
    difficulty: 'hard',
  ...
  },
  {
    ...
    blurb: 'A long gallery of black glass where every reflection is a step behind.',
    story:
      'The gallery stretches deeper than the castle is wide. Julius cuts through its wardens and feels the true presence at the far end turn to watch him.',
    stage: 'library',
    enemy: zombie,
    extraEnemies: [{ def: ghoul, count: 1 }, { def: boneThrower, count: 1 }],
    difficulty: 'hard',
    nextIds: ['gate-vault', 'gate-keep'],
  ...
  },
  {
    ...
    year: 1997,
    title: 'Sunken Vault',
    blurb: 'A flooded treasury the castle keeps just out of reach of the living.',
    story:
      'A drowned vault hoards relics the castle will need in the war to come. Julius empties it early, and its iron keepers do not forgive the theft.',
    stage: 'catacombs',
  ...
  },
  {
    ...
    year: 1997,
    title: 'Castle Keep',
    blurb: 'The heart of a castle that does not exist yet, where Dracula gathers his shape.',
    story:
      'At the top of the keep Dracula’s true form draws itself out of the dark to test the boy who dared come this far — a warning wearing a crown, two years too soon.',
    stage: 'throne_room',
    enemy: dracula1999,
    difficulty: 'hard',
    nextIds: [],
