...
export interface WeaponProfile {
  ...
  swing?: 'slash' | 'chop'
  /** Plant the fighter in place during the swing instead of letting them drift. */
  planted?: boolean
}
...
export const EQUIPMENT_POOL: readonly EquipmentDef[] = [
  ...
  { ...base, id: 'broadsword', name: 'Broadsword', slot: 'weapon', price: 160, blurb: 'Wide, heavy overhead cleave. A quick, planted swing that hits hard.',
    weapon: { reach: 18, width: 130, height: 104, top: 150, startup: 6, active: 5, recovery: 11, damage: 18, knockbackX: 11, knockbackY: -6, color: '#e8dcc0', swing: 'chop', planted: true } },
